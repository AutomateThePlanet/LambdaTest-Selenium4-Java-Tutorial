...
public class ToDoExtentReportTests {
    ...
    public static void setUpClass() {
        ...
        ExtentSparkReporter spark = new ExtentSparkReporter("results.html");
    ...
    public void verifyToDoListCreatedSuccessfully_withParams(String technology){
        var extentTest = extent.createTest("verifyToDoListCreatedSuccessfully_withParams " + technology);
        try {
            driver.navigate().to("https://todomvc.com/");

            extentTest.createNode(Given.class, "navigate" + "https://todomvc.com/");

            openTechnologyApp(technology);

            extentTest.createNode(And.class, "openTechnologyApp" + technology).pass("pass");

            addNewToDoItem("Clean the car");

            extentTest.createNode(When.class, "addNewToDoItem" + "Clean the car").pass("pass");

            addNewToDoItem("Clean the house");

            extentTest.createNode(And.class, "addNewToDoItem" + "Clean the house").pass("pass");

            addNewToDoItem("Buy Ketchup");

            extentTest.createNode(And.class, "addNewToDoItem" + "Buy Ketchup").pass("pass");

            getItemCheckbox("Buy Ketchup").click();

            extentTest.createNode(And.class, "check" + "Buy Ketchup").pass("pass");

            assertLeftItems(2);

            extentTest.createNode(Then.class, "assertLeftItems 2").pass("pass");
