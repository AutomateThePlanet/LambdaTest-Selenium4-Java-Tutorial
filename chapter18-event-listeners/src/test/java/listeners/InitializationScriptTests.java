...
public class InitializationScriptTests {
    ...
    public static void setUpClass() {
        ...
        ExceptionAnalyser.addExceptionAnalysationHandler(new ErrorPageExceptionHandler());
        ExceptionAnalyser.addExceptionAnalysationHandler(new NotFoundPageExceptionHandler());
        ExceptionAnalyser.addExceptionAnalysationHandler(new LoginPageUrlExceptionHandler());
    }
    ...
    public void setUp() {
        ...
        var listener = new WebDriverListener() {
            ...
            public void onException(Throwable e, WebDriver driver) throws AnalyzedTestException {
                ExceptionAnalyser.analyse(driver, (Exception) e);

                // add lambda test logic here
            }
        };
